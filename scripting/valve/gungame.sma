    ...
    */
    ...
    server_print "^n^n^n   Half-Life GunGame Copyright (c) 2014 %s^n",AUTHOR
...
//  playersData[id][PLAYER_BOT] == if(is_user_bot(id))

    if(is_user_bot(id)){
    switch(0,1){
    case 0 : playersData[id][PLAYER_BOT] = false
    case 1 : playersData[id][PLAYER_BOT] = true
    }
    }
    ...
    if (!is_user_bot(id)){set_view(id, CAMERA_3RDPERSON);}
    ...
    {if (is_user_admin(id))Draw_LevelsInHud(id,3);} // TODO: cvar ? ///crashes windows clients
