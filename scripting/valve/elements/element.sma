...
public epoch_clock()
{
    ...
    */
    ...
    g_figure = constraint_offset_fixed(high, low,S_EeD1, offset);
    //nvault_set(g_vault, "day", g_figure);
    g_Nfig = constraint_offset_fixed(high, low,S_EeD2, offset);
    new dark = constraint_offset_fixed(high, low,g_See2, offset);
    new tst[2];
    copy("tst", 2, "dark");
