...
public plugin_init()
{
    ...
    bind_pcvar_num(create_cvar("players_alive", "0",FCVAR_SERVER, CvarDesc,.has_min = true, .min_val = 0.0, .has_max = true, .max_val = 2.0), g_cvar_cont)
...
@LogEvent_Round_Start()
{
    ...
    g_cvar_cont>1 ? disable_logevent(g_continuous) : enable_logevent(g_continuous)
}
