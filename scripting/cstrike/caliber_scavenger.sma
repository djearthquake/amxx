...
public plugin_precache()
{
    ...
    if (!file_exists(szFilePath))
    {
        ...
        if (iFile)
        {
            ...
            fputs(iFile, "556 = models/w_9mmclip.mdl | 100 100 100^n");
            fputs(iFile, "762 = models/w_9mmclip.mdl | 150 150 150^n");
            fputs(iFile, "357sig = models/w_9mmclip.mdl | 200 200 200^n");
...
stock SpawnVisibleMag(id, iWpnID, iAmt)
{
    ...
    else if (BIT_556NATO & (1<<iWpnID)) copy(szKey, charsmax(szKey), "556");
    else if (BIT_762NATO & (1<<iWpnID)) copy(szKey, charsmax(szKey), "762");
    else if (BIT_357SIG & (1<<iWpnID)) copy(szKey, charsmax(szKey), "357sig");
